...
export default function CardPremUsa2() {
  return (
            ...
            <div className="my-2 p-2 bg-white rounded shadow-sm">
                <div className="d-flex text-muted">
                    ...
                    <div className="mt-auto p-2 bd-highlight">
                        <Link to={"/websocket/unit-state/usa2"} className=" text-dark btn btn-outline-primary" role="button">Crear</Link>
                    </div>
                </div>
                <div className="small border-top">
                    <span className="badge bg-success">Online</span>
                    <span className="badge bg-primary">Host: v2ray-usa.tk</span>
