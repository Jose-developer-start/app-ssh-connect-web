                            ...
                            <div className="col-md-4">
                                <div className="p-2 bg-white rounded shadow-sm mb-2">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item py-2">WS Domain 1: canada.vip1.hivevpn.tk
                                    ...
                                    <form method="post" onSubmit={onSubmit}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="openv2ray.com">canada.vip1.hivevpn.tk <span className="badge bg-success">Valid SSL</span></label>
                                            </div>
                                        </div>
