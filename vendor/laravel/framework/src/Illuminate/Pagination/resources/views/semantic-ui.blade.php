@if ($paginator->hasPages())
    <div className="ui pagination menu" role="navigation">
        ...
        @if ($paginator->onFirstPage())
            <a className="icon item disabled" aria-disabled={loading} aria-label="@lang('pagination.previous')"> <i className="left chevron icon"></i> </a>
        @else
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <a className="icon item disabled" aria-disabled={loading}>{{ $element }}</a>
            @endif
        ...
        @else
            <a className="icon item disabled" aria-disabled={loading} aria-label="@lang('pagination.next')"> <i className="right chevron icon"></i> </a>
        @endif
    </div>
@endif
